        ...
        methods: {
            ...
            async getRegistry() {
                if(this.registryid !== null) {
                    try {
                        EventBus.emit('show');
                        let reply  = await this.axios.get(`assetregistry/registries/${this.registryid}`);
            ...
            async getRegistryActivities() {
                if(this.registry) {
                    try {
                        let reply       = await this.axios.get(`assetregistry/registries/${this.registryid}/activities`);
